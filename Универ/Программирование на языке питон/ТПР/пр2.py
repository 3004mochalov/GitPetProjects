...
if __name__ == "__main__":
    arr = [["Эсенево", 8, 105, 4, 7.0, 6.1],
           ["Медведкого", 8.7, 55, 1.2, 6.9, 6.2],
           ["Солнцево", 7.1, 43, 1.6, 5.2, 4.4],
           ["Марьино", 5.2, 26, 2.0, 3.2, 3.1],
           ["Новопеределкино", 8.7, 57, 2.2, 6.9, 6.3],
           ["Ростокино", 10.6, 53, 1.0, 6.8, 6.6],
           ["ВДНХ", 3.1, 55, 1.2, 6.9, 6.2],
           ["Раменки", 3.2, 28, 3.7, 2.2, 2.1],
           ["Савёловская", 11.6, 67, 0.8, 6.9, 6.9],
           ["Мичуринский проспект", 12.1, 60, 0.7, 7.0, 7.0]]
