...
if __name__ == '__main__':
    ...
    arr = [["Эсенево", 8, 105, 4, 7.1, 9.1], ["Медведкого", 7.1, 43, 1.6, 5.2, 4.4],
           ["Солнцево", 7.1, 43, 1.6, 5.2, 4.4], ["Марьино", 5.2, 26, 2.0, 3.2, 3.1],
           ["Новопеределкино", 9.3, 57, 0.9, 6.9, 6.7], ["Ростокино", 10.6, 53, 1.0, 6.8, 6.6],
           ["ВДНХ", 3.3, 28, 3.7, 2.2, 2.1], ["Раменки", 3.4, 28, 3.7, 2.2, 2.1],
    ...
    print("можество парето")
    print(answ)
    pprint(narrowing(answ))
    print("субоптимизация")
    pprint(main_crit(answ))
    print("лексикографическая оптимизация")
    pprint(lex(answ))
